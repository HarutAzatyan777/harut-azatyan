...
const Clients = () => {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText(' harutazatyan45@gmail.com');
    setHasCopied(true);
          ...
          <div key={`review-${item.id}`} className="client-review">
            ...
            <div className="space-y-2">
              ...
              <div className="copy-container" onClick={handleCopy}>
                ...
                <p className="lg:text-2xl md:text-xl font-medium text-gray_gradient text-white">Harutazatyan45@gmail.com
                </p>
              </div>
            </div>
          </div>
