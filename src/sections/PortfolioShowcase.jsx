...
const getProjects = () => [
  ...
  {
    title: "aa Conference Services",
    description: "aa Conference Services is located in Yerevan, Armenia, offering translation, interpretation, and equipment rental services.",
    link: "https://aacs.am/",
    images: [
      "/project5/project1.png",
      "/project5/project2.png",
      "/project5/project3.png",
      "/project5/project4.png",
      "/project5/project5.png",
      "/project5/project6.png",
      "/project5/project7.png",
      "/project5/project8.png",
      "/project5/project9.png",
      "/project5/project10.png",
      "/project5/project11.png",
      "/project5/project12.png",
      "/project5/project13.png",
    ],
    challenges: "Optimizing performance for large data sets and real-time updates.",
    isConfidential: false,
  },
